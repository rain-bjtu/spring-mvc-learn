...
public abstract class PasswordHash {
    ...
    // used to separate each part of the generated value
    ...
    public static String hashPassword(char[] password) throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        return PBKDF2_ITERATIONS + SPLIT_DELIM + toHex(salt) + SPLIT_DELIM + toHex(hash);
    }
    ...
    public static boolean validatePassword(char[] password, String correctHash) throws NoSuchAlgorithmException,
        ...
        String[] params = correctHash.split(SPLIT_DELIM);
    ...
    /**
     * Computes the PBKDF2 hash of a password. This is where the magic happens...
     *
     * @param password
     *            the password to hash.
     * @param salt
